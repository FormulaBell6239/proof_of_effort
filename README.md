...
This repository is MIT-licensed, which means you can use the code (including commercially).
However, the MIT License **does not** grant permission to use the project’s **name, logo, or branding** in ways that could confuse people about what is official or endorsed.
...
For questions or support, please open a GitHub issue.
>>>>>>> 5ff180a (Add trademark, security, and maintainer docs)
